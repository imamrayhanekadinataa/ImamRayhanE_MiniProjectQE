...
public class registerPage extends basePageObject {
    ...
    MobileBy fullnameNull(){
        return (MobileBy) MobileBy.AccessibilityId("Must Fill the fullname");
    }
    MobileBy emailNull(){
        return (MobileBy) MobileBy.AccessibilityId("Must fill the email or password");
    }
    MobileBy registeredEmail(){
        return (MobileBy) MobileBy.AccessibilityId("Already Registered");
    }
